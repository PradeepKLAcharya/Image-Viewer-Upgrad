    ...
    if (this.state.username !== "" && this.state.password !== "") {
      if (
        ...
        sessionStorage.setItem(
          "access-token",
          "IGQVJXaEF4ZAFRQc3RWQWR2V0JYUlFBeFVkbDlsTDJNQmN0UW5zaVR0Vk9YNlFjTk9kY1VqWTRvemIxeWk2TWhnRXRzM1IyMm0wQ3c1ZAm1kS3pEYmZAKMy1CNEozencwUURRZA0NpeEo2WG44aWxJRlRlUAZDZD"
        );
